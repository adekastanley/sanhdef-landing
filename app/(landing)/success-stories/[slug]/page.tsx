		...
		<div className="min-h-screen bg-cream pb-20 pt-32">
			...
			<div className="relative h-[50vh] min-h-[400px] w-full container mx-auto rounded-[2.5rem] overflow-hidden">
				<Image
					...
					priority
				/>
				<div className="absolute inset-0 bg-linear-to-t from-dark-green via-dark-green/60 to-transparent" />
				<div className="absolute bottom-0 left-0 right-0 px-8 pb-12 text-cream">
					<Link
						href="/projects#stories"
						className="inline-flex items-center text-sm font-bold uppercase tracking-widest hover:text-lime mb-6 transition-colors"
					>
						<ArrowLeft className="mr-2 h-4 w-4" /> Back to Success Stories
					</Link>
					<Badge className="bg-lime text-dark font-bold px-3 py-1 uppercase tracking-widest mb-4 border-none shadow-sm">
						Success Story
					</Badge>
					...
					<div className="md:w-72 shrink-0 space-y-8">
						<div className="sticky top-32 p-8 bg-white rounded-[2rem] border border-dark/5 shadow-sm">
							...
							<div className="flex flex-col gap-4">
								<Button
									variant="outline"
									className="justify-start w-full border-dark/10 text-dark font-bold rounded-full h-12 hover:bg-lime hover:border-lime hover:text-dark transition-all"
								>
